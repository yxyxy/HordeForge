...
| Tests (unit/integration) | P0 | partial | 500+ unit/integration test cases, pipeline smokes, load tests, benchmark tests, plus pipeline-catalog static/runtime smoke gates (`tests/unit/pipelines/test_pipeline_catalog_validation.py`, `tests/integration/test_pipeline_catalog_runtime.py`) | deploy-level E2E against live services, soak/chaos profile |
